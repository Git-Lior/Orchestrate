...
{
    public class UsersRepository : EntityRepositoryBase<User>
    {
        ...
        public async Task<LoggedInUserData> AuthenticateUser(string email, string password)
        {
            ...
            return Mapper.Map<LoggedInUserData>(user);
        }
